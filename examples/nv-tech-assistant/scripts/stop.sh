...
#
# Stop the nv-tech-assistant sandbox without deleting its workspace or
# credentials. Restart it later with scripts/start.sh.
...
run nemoclaw "$NEMOCLAW_SANDBOX_NAME" stop

echo
echo "Stopped without deleting workspace state."
